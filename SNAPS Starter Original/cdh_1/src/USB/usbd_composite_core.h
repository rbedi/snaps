...
/** @defgroup usbd_cdc_Exported_Defines
  * @{
  */ 
#define USB_CDC_CONFIG_DESC_SIZ                (107)
#define USB_CDC_DESC_SIZ                       (107-9) // 107, 32


#define HID_TELEMATICS_REPORT_DESC_SIZE    94
...
typedef  void (*usbReceiveFn)(void*, size_t);

void SetUSBReceiveCallback(usbReceiveFn);
